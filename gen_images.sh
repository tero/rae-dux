...
${container_cmd} run ${container_args} yaqwsx/kikit:v1.0.0 pcbdraw -b --style builtin:oshpark-afterdark.json output/pcbs/board-routed.kicad_pcb images/board-right.png
